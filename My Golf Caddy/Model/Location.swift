...
struct Options: Codable {
    let maxResults: Int?
    let thumbMaps, ignoreLatLngInput: Bool?
}
...
struct LocationElement: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case street, adminArea6, adminArea6Type, adminArea5, adminArea5Type, adminArea4, adminArea4Type, adminArea3, adminArea3Type, adminArea1, adminArea1Type, postalCode, geocodeQualityCode, geocodeQuality, dragPoint, sideOfStreet
        case linkID = "linkId"
        case unknownInput, type, latLng, displayLatLng
        case mapURL = "mapUrl"
    }
}
